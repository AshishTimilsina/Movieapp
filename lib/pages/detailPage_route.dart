...
class DProutepage extends StatelessWidget {
  final Movie movie;
  const DProutepage(this.movie, {super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final videodataa = ref.watch(videoprovider(movie.id));
        final rcmddataa = ref.watch(rcmdprovider(movie.id));
        return Column(
